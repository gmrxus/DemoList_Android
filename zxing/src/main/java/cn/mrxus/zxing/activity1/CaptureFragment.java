package cn.mrxus.zxing.activity1;
...
import cn.mrxus.zxing.activity.*;
import cn.mrxus.zxing.camera.CameraManager;
import cn.mrxus.zxing.decoding.CaptureActivityHandler;
...
//            CameraManager.get().openDriver(surfaceHolder);
        ...
        if (handler == null) {
//            cn.mrxus.zxing.activity.CaptureActivity activity = this.getActivity();
//            handler = new CaptureActivityHandler(activity, decodeFormats, characterSet, viewfinderView);
        }
    }
